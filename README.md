...
O principal objetivo é utlizar o modelo unet++ para melhor precisão da retina em relação ao modelo unet convencional. O resultado da predição deve ser o mais próximo possivel da segunda imagem, como mostrar abaixo:
